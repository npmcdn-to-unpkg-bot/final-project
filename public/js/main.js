...
$(document).ready(function() {
  ...
  //             window.open('https://blooming-stream-74013.herokuapp.com/api/player/spotify:track:'+event.target.getAttribute('track_id'), 'musicPlayer', "height=400,width=380")
  //           })
  //         })
  //       })
        ...
        $.ajax({
          ...
          $(".play-playlist").on('click', function(event) {
            ...
            $.ajax({
              ...
              console.log(results)
              window.open('https://blooming-stream-74013.herokuapp.com/api/player/'+event.target.getAttribute('playlist_id'), 'musicPlayer', "height=300,width=380")
            })
          })
        })
      });
